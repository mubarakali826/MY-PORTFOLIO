...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_1m7eaen', 'template_0hpkmmv', ref.current, {
        publicKey: 'QNB5FGgsCjQ9nCxLa',
      })
      .then(
        () => {
          setSuccess(true);
    ...
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
            <h2>Mail</h2>
            <span>kingjohn135251@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
            <h2>Address</h2>
            <span>Haripur,KPK Pakistan</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
            <h2>Phone</h2>
            <span>+92 3161531077</span>
        </motion.div>
